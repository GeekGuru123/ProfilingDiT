...
#     group.add_argument("--step_cache_list", type=list, default=[6, 16, 30, 41, 48])
#     # group.add_argument("--block_cache_list", type=list, default=[1, 3, 8, 9, 22, 24, 28, 29, 30, 32, 34, 35, 36, 37, 38, 39])
